...
public class ConsultarMedico extends javax.swing.JFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        idMedico.setForeground(new java.awt.Color(0, 0, 204));
        idMedico.setText("ID Médico");

        ingresaIdMedico.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(ingresaIdMedico, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(idMedico)
                            .addComponent(ingresaIdMedico, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(32, 32, 32)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(especialidad)
...
dispose es un método de la clase Window, con esa instrucción cierras la ventana actual
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
       // Me permite volver a dejar los campos vacios para volver a agregar otro identificacion de médico.       
...
// si el campo de ingresa cedula no es vacio entonces se obtiene la cedula.	
	  ...
	  Medico medico = GestionarCita.obtenerMedicoPorIdentificacion(ingresaCedula.getText());
// si los campos estan vacios se obtiene el valor de los metodos getter      	
	  if (medico != null) {
	     ingresaNombre.setText(medico.getNombre());
	     ingresaApellido.setText(medico.getApellido());
	     ingresaCorreo.setText(medico.getCorreo());
	     ingresaTelefono.setText(Integer.toString(medico.getTelefono()));
	     ingresaIdMedico.setText(Integer.toString(medico.getIdMedico()));
	     ingresaEspecialidad.setText(medico.getEspecialidad());
	  } else {
